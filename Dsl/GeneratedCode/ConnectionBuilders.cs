...
namespace UPM_IPS.JSRBBRProyectoIPS
{
	...
	/// ConnectionBuilder class to provide logic for constructing connections between elements.
	/// </summary>
	public static partial class ClaseAbstractaReferencesClaseHijaDeAbstractaBuilder
	{
		#region Accept Connection Methods
		/// <summary>
		/// Test whether a given model element is acceptable to this ConnectionBuilder as the source of a connection.
		...
		{
			if (candidate == null) return false;
			else if (candidate is global::UPM_IPS.JSRBBRProyectoIPS.ClaseAbstracta)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::UPM_IPS.JSRBBRProyectoIPS.ClaseAbstracta)
				{
					if (candidateTarget is global::UPM_IPS.JSRBBRProyectoIPS.Clase)
					{
						global::UPM_IPS.JSRBBRProyectoIPS.ClaseAbstracta sourceClaseAbstracta = (global::UPM_IPS.JSRBBRProyectoIPS.ClaseAbstracta)candidateSource;
						global::UPM_IPS.JSRBBRProyectoIPS.Clase targetClase = (global::UPM_IPS.JSRBBRProyectoIPS.Clase)candidateTarget;
						if(targetClase == null || sourceClaseAbstracta == null || global::UPM_IPS.JSRBBRProyectoIPS.ClaseAbstractaReferencesClaseHijaDeAbstracta.GetLinks(sourceClaseAbstracta, targetClase).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			if (CanAcceptSourceAndTarget(source, target))
			{
				if (source is global::UPM_IPS.JSRBBRProyectoIPS.ClaseAbstracta)
				{
					if (target is global::UPM_IPS.JSRBBRProyectoIPS.Clase)
					{
						global::UPM_IPS.JSRBBRProyectoIPS.ClaseAbstracta sourceAccepted = (global::UPM_IPS.JSRBBRProyectoIPS.ClaseAbstracta)source;
						global::UPM_IPS.JSRBBRProyectoIPS.Clase targetAccepted = (global::UPM_IPS.JSRBBRProyectoIPS.Clase)target;
						DslModeling::ElementLink result = new global::UPM_IPS.JSRBBRProyectoIPS.ClaseAbstractaReferencesClaseHijaDeAbstracta(sourceAccepted, targetAccepted);
						if (DslModeling::DomainClassInfo.HasNameProperty(result))
						{
							DslModeling::DomainClassInfo.SetUniqueName(result);
						}
