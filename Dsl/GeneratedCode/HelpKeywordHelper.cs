...
namespace UPM_IPS.JSRBBRProyectoIPS
{
	...
	/// </remarks>
	public partial class JSRBBRProyectoIPSHelpKeywordHelper : JSRBBRProyectoIPSHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new JSRBBRProyectoIPSHelpKeywordHelper.
		/// </summary>
		protected JSRBBRProyectoIPSHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the JSRBBRProyectoIPSHelpKeywordHelper.
		/// </summary>
		public static JSRBBRProyectoIPSHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class JSRBBRProyectoIPSHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new JSRBBRProyectoIPSHelpKeywordHelperBase.
		/// </summary>
		protected JSRBBRProyectoIPSHelpKeywordHelperBase()
			: base() { }
