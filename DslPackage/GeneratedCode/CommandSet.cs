...
namespace UPM_IPS.JSRBBRProyectoIPS
{
	...
	/// </summary>
	internal partial class JSRBBRProyectoIPSCommandSet : JSRBBRProyectoIPSCommandSetBase
	{
		/// <summary>
		/// Constructs a new JSRBBRProyectoIPSCommandSet.
		/// </summary>
		public JSRBBRProyectoIPSCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class JSRBBRProyectoIPSCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new JSRBBRProyectoIPSCommandSetBase.
		/// </summary>
		protected JSRBBRProyectoIPSCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewJSRBBRProyectoIPSExplorerCommand,
				typeof(JSRBBRProyectoIPSEditorFactory).GUID);
		...
		{
			JSRBBRProyectoIPSExplorerToolWindow explorer = this.JSRBBRProyectoIPSExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected JSRBBRProyectoIPSDocData CurrentJSRBBRProyectoIPSDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as JSRBBRProyectoIPSDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected JSRBBRProyectoIPSDocView CurrentJSRBBRProyectoIPSDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as JSRBBRProyectoIPSDocView;
			}
		}
		...
		/// </summary>
		protected JSRBBRProyectoIPSExplorerToolWindow JSRBBRProyectoIPSExplorerToolWindow
		{
			get
			{
				JSRBBRProyectoIPSExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(JSRBBRProyectoIPSExplorerToolWindow), true) as JSRBBRProyectoIPSExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				JSRBBRProyectoIPSExplorerToolWindow explorerWindow = this.JSRBBRProyectoIPSExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class JSRBBRProyectoIPSClipboardCommandSet : JSRBBRProyectoIPSClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new JSRBBRProyectoIPSClipboardCommandSet.
		/// </summary>
		public JSRBBRProyectoIPSClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class JSRBBRProyectoIPSClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new JSRBBRProyectoIPSClipboardCommandSetBase.
		/// </summary>
		protected JSRBBRProyectoIPSClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
