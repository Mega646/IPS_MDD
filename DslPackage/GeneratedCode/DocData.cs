...
namespace UPM_IPS.JSRBBRProyectoIPS
{
	...
	/// </summary>
	internal partial class JSRBBRProyectoIPSDocData : JSRBBRProyectoIPSDocDataBase
	{
		/// <summary>
		/// Constructs a new JSRBBRProyectoIPSDocData.
		/// </summary>
		public JSRBBRProyectoIPSDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a JSRBBRProyectoIPS document in memory.
	/// </summary>
	internal abstract partial class JSRBBRProyectoIPSDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new JSRBBRProyectoIPSDocDataBase.
		/// </summary>
		protected JSRBBRProyectoIPSDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::UPM_IPS.JSRBBRProyectoIPS.JSRBBRProyectoIPSDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::UPM_IPS.JSRBBRProyectoIPS.JSRBBRProyectoIPSDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::UPM_IPS.JSRBBRProyectoIPS.JSRBBRProyectoIPSDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::UPM_IPS.JSRBBRProyectoIPS.JSRBBRProyectoIPSDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::UPM_IPS.JSRBBRProyectoIPS.TapizClases modelRoot = null;
			...
			global::UPM_IPS.JSRBBRProyectoIPS.JSRBBRProyectoIPSDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::UPM_IPS.JSRBBRProyectoIPS.JSRBBRProyectoIPSSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::UPM_IPS.JSRBBRProyectoIPS.JSRBBRProyectoIPSDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::UPM_IPS.JSRBBRProyectoIPS.JSRBBRProyectoIPSDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		protected virtual void OnDocumentLoaded()
		{
			...
			global::UPM_IPS.JSRBBRProyectoIPS.TapizClases modelRoot = this.RootElement as global::UPM_IPS.JSRBBRProyectoIPS.TapizClases;
			if (modelRoot != null)
			{
				...
				if (diagrams.Count > 0)
				{
					global::UPM_IPS.JSRBBRProyectoIPS.JSRBBRProyectoIPSDiagram diagram = diagrams[0] as global::UPM_IPS.JSRBBRProyectoIPS.JSRBBRProyectoIPSDiagram;
					if (diagram != null)
					{
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::UPM_IPS.JSRBBRProyectoIPS.TapizClases modelRoot = (global::UPM_IPS.JSRBBRProyectoIPS.TapizClases)this.RootElement;
			...
			if (diagrams.Count > 0 && (!saveAs || this.diagramDocumentLockHolder == null))
			{
				...
				if (diagram != null)
				{
					...
					try
					{
						...
						global::UPM_IPS.JSRBBRProyectoIPS.JSRBBRProyectoIPSSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::UPM_IPS.JSRBBRProyectoIPS.JSRBBRProyectoIPSSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::UPM_IPS.JSRBBRProyectoIPS.JSRBBRProyectoIPSDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::UPM_IPS.JSRBBRProyectoIPS.JSRBBRProyectoIPSSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				...
				if (modelRoot != null)
				{
					modelFile = global::UPM_IPS.JSRBBRProyectoIPS.JSRBBRProyectoIPSSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
